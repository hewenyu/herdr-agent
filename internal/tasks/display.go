...
func Parse(text string) (Command, bool) {
	...
	for _, q := range []string{"有哪些任务正在进行", "现在还有哪些任务", "现在有哪些任务", "目前还有哪些任务", "还有哪些任务", "目前有哪些任务", "列出进行中的任务", "总结一下正在进行的任务", "帮我总结一下正在进行的任务", "总结进行中的任务", "正在进行哪些任务", "现在有哪些任务在进行", "现在有哪些任务在进行？", "正在进行哪些任务？", "有哪些任务在进行", "任务进度", "查看任务", "查看进行中的任务", "现在进行中的任务"} {
