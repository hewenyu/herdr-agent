...
| D03 | AI 新建任务默认模型持续调度；兼容显式手动和有界轮转 | 模型依据已结束的真实输出决定分派、返工、验证与委托汇总；默认 32 次决策、240 分钟。旧任务和显式 discussion.mode 保持旧策略，round_robin 默认 4 轮、30 分钟。交付不等于用户验收；详见[调度审计](ai-orchestration-audit-2026-09-25.md) |
