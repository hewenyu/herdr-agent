...
PR #28 的工具事实护栏修正和 PR #31 的旧版工具计数护栏修正已包含在 `v0.3.8`。仓库根目录的 `package.json` 是私有源码包，版本仍为 `0.3.0`，不是公开发布的 npm 主入口包。下面记录的本机 SEA 证据从合并提交 `452aae9` 重建并重启为 `v0.3.7`（PID `31577`，SHA256 `f717b402b2cc82f6fc815046d0b20eef4287c751238cb5593a2f0a4a9a412aec`）。
